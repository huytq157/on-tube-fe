    ...
    <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        <button
          ...
          className="flex w-full gap-3 justify-center rounded-md bg-[#eee] px-3 py-2 text-sm font-semibold leading-6 text-[#000] shadow-md focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 "
        >
